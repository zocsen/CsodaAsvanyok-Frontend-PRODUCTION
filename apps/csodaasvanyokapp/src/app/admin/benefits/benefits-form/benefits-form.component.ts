      ...
      .subscribe({
        next: () => {
          this.messageService.add({
            severity: 'success',
            summary: 'Siker!',
            detail: `A ${benefit.name} hatás sikeresen szerkesztve lett!`,
          });
          setTimeout(() => {
            this.backClicked();
          }, 1500);
        ...
        error: () =>
          this.messageService.add({
            severity: 'error',
            summary: 'Hiba!',
            detail: 'A hatást nem sikerült szerkeszteni!',
          }),
      });
  }
      ...
      .subscribe({
        next: () => {
          this.messageService.add({
            severity: 'success',
            summary: 'Siker!',
            detail: `A ${benefit.name} hatás sikeresen létrehozva!`,
          });
          this.form.reset();
        },
        error: () =>
          this.messageService.add({
            severity: 'error',
            summary: 'Hiba!',
            detail: 'A hatást nem sikerült létrehozni!',
          }),
      });
  }
